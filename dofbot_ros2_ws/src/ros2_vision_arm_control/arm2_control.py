...
class ArmControl(Node):
    def __init__(self,urdf_path):
        ...
        self.status_publisher = self.create_publisher(String, TOPIC_ROBOT2_STATUS, 10)
        self.transform_publisher = self.create_publisher(Float32MultiArray, TOPIC_ROBOT2_TRANSFORM, 10)
