...
#include "ros2_vision_arm_control/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros2_vision_arm_control::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_vision_arm_control::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &ros2_vision_arm_control::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
