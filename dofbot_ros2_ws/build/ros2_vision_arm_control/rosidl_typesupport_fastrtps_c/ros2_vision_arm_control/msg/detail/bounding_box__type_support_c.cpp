...
#include "ros2_vision_arm_control/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox__ros_msg_type = ros2_vision_arm_control__msg__BoundingBox;
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_vision_arm_control__msg__BoundingBox(
...
{
  return max_serialized_size_ros2_vision_arm_control__msg__BoundingBox(
    full_bounded, 0);
}
