...
bool ros2_vision_arm_control__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_vision_arm_control.msg._bounding_box.BoundingBox", full_classname_dest, 53) == 0);
  }
  ros2_vision_arm_control__msg__BoundingBox * ros_message = _ros_message;
  {  // xmin
...
PyObject * ros2_vision_arm_control__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_vision_arm_control.msg._bounding_box");
