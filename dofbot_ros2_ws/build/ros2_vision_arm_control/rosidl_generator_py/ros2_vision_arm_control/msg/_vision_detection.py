    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros2_vision_arm_control.msg.VisionDetection')
            logger.debug(
            ...
            from ros2_vision_arm_control.msg import BoundingBox
...
class VisionDetection(metaclass=Metaclass_VisionDetection):
    ...
    _fields_and_field_types = {
        ...
        'boxes': 'sequence<ros2_vision_arm_control/BoundingBox>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'Image'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['sensor_msgs', 'msg'], 'Image'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros2_vision_arm_control', 'msg'], 'BoundingBox')),  # noqa: E501
    )
