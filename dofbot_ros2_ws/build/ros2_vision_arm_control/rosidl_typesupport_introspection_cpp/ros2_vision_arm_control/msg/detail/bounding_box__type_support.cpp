...
{
  new (message_memory) ros2_vision_arm_control::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_vision_arm_control::msg::BoundingBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[7] = {
  {
    ...
    offsetof(ros2_vision_arm_control::msg::BoundingBox, xmin),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_vision_arm_control::msg::BoundingBox, ymin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_vision_arm_control::msg::BoundingBox, xmax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_vision_arm_control::msg::BoundingBox, ymax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_vision_arm_control::msg::BoundingBox, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_vision_arm_control::msg::BoundingBox, class_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<ros2_vision_arm_control::msg::BoundingBox>()
{
  return &::ros2_vision_arm_control::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_vision_arm_control, msg, BoundingBox)() {
  return &::ros2_vision_arm_control::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
