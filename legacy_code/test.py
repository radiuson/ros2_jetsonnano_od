...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/jetson/code/yolov5/yolov5-3.0/runs/exp3/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='/home/jetson/code/yolov5/tomato-v6/data.yaml', help='*.data path')
